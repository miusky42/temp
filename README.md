...
2) Training parameters, training logs, test outputs, and evaluation results for the EduRABSA_SLM Models.
...
&emsp;&emsp;  <img src="https://github.com/miusky42/temp/blob/main/.figs/fig_table_1.png?raw=true" alt="ABSA examples" width="850px;">
